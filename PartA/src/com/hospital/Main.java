...
/**
 * Main simulator class for Part A: Monitor using synchronized (implicit locks).
 * 
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("PART A: Monitor using synchronized (Implicit Locks)");
        System.out.println("=".repeat(60));
        ...
        System.out.println("\n" + "=".repeat(60));
        System.out.println("PART A: Simulation Complete");
        System.out.println("=".repeat(60));
    }
