...
/**
 * Main simulator class for Part C: ReentrantLock + Condition.
 * 
 * This implementation demonstrates both Producer-Consumer and Reader-Writer patterns
 * using explicit locks (ReentrantLock) and Condition variables instead of
 ...
 * - Condition.signal()/signalAll() instead of notify()/notifyAll()
 * - Explicit lock.lock() and lock.unlock()
 * - Separate condition variables for different wait sets
 * 
 * Advantages:
 * - More flexible than synchronized
 * - Multiple condition variables possible
 * - Try-lock and timed lock support
 * - Fairness policies available
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("PART C: ReentrantLock + Condition");
        System.out.println("=".repeat(60));
        ...
        System.out.println("\n" + "=".repeat(60));
        System.out.println("PART C: Simulation Complete");
        System.out.println("=".repeat(60));
    }
